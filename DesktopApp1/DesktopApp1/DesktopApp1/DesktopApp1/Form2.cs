    ...
    public partial class Form2 : Form
    {
        ...
        private void timerSwap_Tick(object sender, EventArgs e)
        {
            ...
            if (comboBox1.SelectedIndex==1)
            {
                ...
                if (kts == 0)
                {
                    pictureBox1.Location = new Point(460, 70);
                    textBoxkq.Text = "";
            ...
            if (comboBox1.SelectedIndex == 2)
            {
                ...
                if (sort ==1)
                {
                    if (pos > 0 && a[pos - 1-tt] > a[pos-tt])
                    {
                        ...
                        pictureBoxi.Location = new Point(Sau1.Location.X, Sau1.Location.Y - 150);
            ...
            if (comboBox1.SelectedIndex==3)
            {
                ...
                if (sort==2)
                {
                    sort = -2;
                    textBoxkq.Text = null;
                    pictureBox1.Location = new Point(460, 30);
            ...
            if (comboBox1.SelectedIndex==4)
            {
                ...
                if (heapsort == 8)
                {
                    ...
                    if (sl < 1)
                    {
                        ...
                        timerSwap.Enabled = false;
                        textBoxkq.Text = "Đã xong giao đoạn 2";
        ...
        private void buttonGD1_Click(object sender, EventArgs e)
        {
            ...
            pictureBoxsosanh1.Image = Properties.Resources.images2;
            labeli.Text = "left";
            labelj.Text = "Curr";
            labelai.Text = "joint";
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            if (comboBox1.SelectedIndex == 0)
            {
                ...
                if (kt == 5)
                {
                    ...
                    qq2.BackColor = Color.Red;

                }
                if (kt == 6)
                {
                    pictureBoxsosanh.Visible = false;
                    pictureBox1.Location = new Point(450, 50);
            ...
            if (comboBox1.SelectedIndex==4)
            {
                ...
                if (kt == 3)
                {
                    if (ktjoint1 == false)
                    {
                        ...
                        if (int.Parse(qq.Text) < int.Parse(qq1.Text))
                        {
                            textBoxkq.Text = "Doi cho " + qq.Text + " va " + qq1.Text;
                            doicho1 = true;
                        }
                        else textBoxkq.Text = "khong lam gi";
                        pictureBox1.Location = new Point(470, 160);
                    }
                    else
                    {
                        ...
                        if (int.Parse(qq.Text) < int.Parse(cc.Text) && int.Parse(cc.Text)>int.Parse(cc1.Text))
                        {
                            textBoxkq.Text = "Doi cho " + qq.Text + " va " + cc.Text;
                            doicho1 = true;
                        }
                        else if (int.Parse(qq.Text) < int.Parse(cc1.Text))
                        {
                            textBoxkq.Text = "Doi cho " + qq.Text + " va " + cc1.Text;
                            doicho2 = true;
            ...
            if (comboBox1.SelectedIndex==6)
            {
                ...
                if (kt == 3)//kiem tra trai.text<tam.text?trai++:tới lượt phải
                {
                    ...
                    {
                        textBoxkq.Text = "a[i] nhỏ hơn " + textBoxtam.Text + " i++";
                        trai++;
                        kt = 0;
                    }
